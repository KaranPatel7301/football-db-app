...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teamSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
...

            {
                ...
                changeNumberSpinner(numberSpinner, NumberAdapter, teamSpinner.getSelectedItem().toString());
            }
    ...
    protected void changeNumberSpinner(Spinner numberSpinner, ArrayAdapter NumberAdapter, String team) {
        if(team.equals("Kansas City Chiefs")) {
            NumberAdapter = new ArrayAdapter<String>(MainActivity.this,
                    android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.Chief_Jersey));
            NumberAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            numberSpinner.setAdapter(NumberAdapter);
        } else if (team.equals("Tampa Bay Buccaneers")) {
            NumberAdapter = new ArrayAdapter<String>(MainActivity.this,
                    android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.Tampa_Jersey));
            NumberAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            numberSpinner.setAdapter(NumberAdapter);
        }
    }
